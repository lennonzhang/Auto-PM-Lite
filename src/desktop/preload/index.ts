...
const api: DesktopApi = {
  ...
  sendTurn: (input) => invokeApi(ipcChannels.tasksSendTurn, input),
  ...
  closeTask: (input) => invokeApi(ipcChannels.tasksClose, input),
  handoffTask: (input) => invokeApi(ipcChannels.tasksHandoff, input),
  forkTask: (input) => invokeApi(ipcChannels.tasksFork, input),
  rolloverSession: (input) => invokeApi(ipcChannels.tasksRollover, input),
